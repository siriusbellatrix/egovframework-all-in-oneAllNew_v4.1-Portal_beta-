                                ...
                                <div class="board_view">
                                    ...
                                    <div class="board_view_bot">
                                        ...
                                        <div class="right_col btn1">
                                        	<a href="#LINK" class="btn btn_blue_46 w_100" onclick="fn_egov_updt_faqcn(document.faqManageVO,'<c:out value="${result.faqId}"/>'); return false;"><spring:message code="button.save" /></a><!-- 저장 -->
                                            <a href="#LINK" class="btn btn_blue_46 w_100" onclick="fn_egov_inqire_faqcnlist(); return false;"><spring:message code="button.list" /></a><!-- 목록 -->
                                        </div>
                                    </div>
                                </div>
                                <!-- FAQ -->
