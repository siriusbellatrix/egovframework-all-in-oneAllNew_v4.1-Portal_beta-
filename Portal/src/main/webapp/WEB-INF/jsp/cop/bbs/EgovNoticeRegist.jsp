                                ...
                                <div class="board_view2">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input id="nttSj" name="nttSj" type="text" size="60" value=""  maxlength="60" class="f_txt w_full">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <textarea id="nttCn" name="nttCn" class="textarea f_txtar w_full h_200" cols="30" rows="10" ></textarea>
